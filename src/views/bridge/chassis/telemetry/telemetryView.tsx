...
import type {
  ...
  TelemetryViewProps,
} from '../../../../features/systems/bridge/chassis/telemetry/telemetrySelectors'
 ...
 * their stations, so each permanent readout carries unique information.
 */
...
const Telemetry: React.FC<TelemetryViewProps> = ({ feed, theme }) => (
  <XStack
    className="telemetry"
    position="relative"
    paddingHorizontal="$4"
