...
import { useGetGithubSummaryQuery } from '../../../../features/systems/platform/foundation/api/apiApi'
import { useArchiveControlComposition } from '../../../../features/systems/shell/controls/archiveControl/archiveControlThunks'
import type { GithubSummary } from '../../../../features/components/platform/foundation/api/apiTypes'
import { renderWithProviders } from '../../../../test/providers.test.helper'

jest.mock('../../../../features/systems/platform/foundation/api/apiApi', () => ({
  ...jest.requireActual('../../../../features/systems/platform/foundation/api/apiApi'),
